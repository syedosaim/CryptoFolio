...
//To create model i used app.quicktype.io
...
struct CoinModel: Identifiable, Codable {
    ...
    let currentHoldings: Double? //added by me to save current holdings
    
    enum CodingKeys: String, CodingKey {
        case id, symbol, name, image //we dont need key because key is same as name
